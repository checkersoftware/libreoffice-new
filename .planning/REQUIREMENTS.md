...
**Priority:** P1 (Table Stakes)
**Description:** The C++ to JS call uses `EM_ASYNC_JS` with JSPI (JavaScript Promise Integration) to suspend the WASM thread while JavaScript resolves the font. This makes the inherently async JS operation appear synchronous to LibreOffice's synchronous font resolution pipeline. The function must be added to `-sJSPI_EXPORTS` in the Emscripten build configuration.
...
| REQ-F07 | Phase 2 | Pending |
| REQ-F08 | Phase 2 | Pending |
| REQ-F09 | Phase 2 | Pending |
| REQ-F10 | Phase 3 | Pending |
| REQ-F11 | Phase 3 | Pending |
| REQ-N01 | Phase 1 | Pending |
| REQ-N02 | Phase 1 | Pending |
| REQ-N03 | Phase 1 | Pending |
| REQ-N04 | Phase 1 | Pending |
...
*Traceability updated: 2026-02-09 (phase mappings added)*
